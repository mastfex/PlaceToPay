...
public class DemoMetodosService {
    ...
    private static com.example.demo.response.tokenize.Output tokenizeWebClient(com.example.demo.request.tokenize.Input json) {
    ...
    private static com.example.demo.response.transaction.Output processWebClient(com.example.demo.request.transaction.Input json) {
		WebClient clientFlux = WebClient.builder().baseUrl("https://test.placetopay.ec/rest").build();
    ...
    private static com.example.demo.response.query.OutputQuery tokenizeWebClient(com.example.demo.request.query.InputQuery json) {
		WebClient clientFlux = WebClient.builder().baseUrl("https://test.placetopay.ec/rest").build();
